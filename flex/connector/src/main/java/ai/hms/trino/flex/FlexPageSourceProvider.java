 ...
 * {@code Page}s.
 *
 * We override the credentials-carrying overload (the one the engine's
 * MemoryContext variant delegates to); flex has no per-query credential or
 * predicate passthrough, so those args are ignored.
 */
